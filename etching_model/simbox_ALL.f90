...
write(777,*) 'n_cluster = ',n_cluster
do i = 1,natom
write(777,*) i,atomL(i)
end do
call check_proximity(consistent,ii)
print *,consistent
if (.NOT.consistent) then
print *,'ii = ',ii
stop
end if
call check_proximity2(consistent,ii)
print *,consistent
if (.NOT.consistent) then
print *,'2 ii = ',ii
stop
...
!             lstSi%i = 0
!         do j = 1,natom
!            if (atom(j) == iSilicon) call add_to_list(lstSi,j)
!        end do
...
write(888,*) i
write(888,*)'iat = ',iat
write(888,*)'before delete'
write(888,*)'natom = ',natom
write(888,'(i5,a4,4i5)') iat,atom_name(atom(iat)),proximity(iat,:)
do j = 1,ncmax(atom(iat))
   k = proximity(iat,j)
   if (k == 0) cycle
   write(888,'(i5,a4,4i5)') k,atom_name(atom(k)),proximity(k,:)
end do
write(888,'(i5,a4,4i5)') natom,atom_name(atom(natom)),proximity(natom,:)
do j = 1,ncmax(atom(natom))
   k = proximity(natom,j)
   if (k == 0) cycle
   write(888,'(i5,a4,4i5)') k,atom_name(atom(k)),proximity(k,:)
end do
write(888,*)'lstSi%n = ',lstSi%n
do j = 1,lstSi%n
   write(888,*) j,lstSi%i(j)
end do
...
write(888,'(i5,a4,4i5)') natom + 1,atom_name(atom(natom + 1)),proximity(natom + 1,:)
do j = 1,ncmax(atom(natom + 1))
   k = proximity(natom + 1,j)
   if (k == 0) cycle
   write(888,'(i5,a4,4i5)') k,atom_name(atom(k)),proximity(k,:)
end do
write(888,*)'lstSi%n = ',lstSi%n
...
print *,'****i = ',i
print *,'natom = ',natom,natom_max
print *,'proximity(natom + 1:,:) ',proximity(natom + 1:,:)
stop
end if
...
!    *************************************
      ...
      write(*,*) n_crossbond_y
      write(*,*) n_crossbond_z
        if (n_crossbond_x == 0) cycle
      if (n_crossbond_y == 0) cycle
      if (n_crossbond_z == 0) cycle
