...
PROGRAM SIMBOX
      ...
      integer:: j,i,m,n,ib,k,iat,ii,imve,ic = 0,natomc,ix,iy,iz,n1,n2
...
!
      ...
      do i = 1,n_crossbond_x
print *,'i = ',i
print *,'lst_pos_x%i(i) ',lst_pos_x%i(i)
print *,'lst_neg_x%i(i) ',lst_neg_x%i(i)
print *,'proximity(lst_pos_x%i(i),:) ',proximity(lst_pos_x%i(i),:)
         call set_proximity(lst_pos_x%i(i),lst_neg_x%i(i),lst_neg_x%i(i) + natom)
print *,'proximity(lst_pos_x%i(i),:) ',proximity(lst_pos_x%i(i),:)
print *,'proximity(lst_neg_x%i(i),:) ',proximity(lst_neg_x%i(i),:)
         call set_proximity(lst_neg_x%i(i),lst_pos_x%i(i),lst_pos_x%i(i) + natom)
print *,'proximity(lst_neg_x%i(i),:) ',proximity(lst_neg_x%i(i),:)
      end do
      lst_pos_x%i(1:lst_pos_x%n) = lst_pos_x%i(1:lst_pos_x%n) + natom
      n1 = lst_pos_y%n
      n2 = lst_pos_z%n
      lst_pos_y%i(n1 + 1:2*n1) = lst_pos_y%i(1:n1) + natom
      lst_pos_z%i(n2 + 1:2*n2) = lst_pos_z%i(1:n2) + natom
