MODULE NLIST_MOD
   ...
   integer,parameter:: ncelmax = 150000
   integer,parameter,public::nlmax = 4
   integer,parameter:: neighmx = (2*nlmax + 1)**3
...
CONTAINS
   ...
   SUBROUTINE INIT_NLIST(Lx,Ly,Lz,Rc,natom_max)
      ...
      if (ncelt > ncelmax) STOP 'error INIT_NLIST: '
      delx = Lx/ncelx
      dely = Ly/ncely
      delz = Lz/ncelz
