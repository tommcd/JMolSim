...
PROGRAM SIMBOX
      ...
      real(wp):: r1(3),r2(3),rmax,rmax2,rl1,rl2
...
!
      ...
      if (narg /= 5) then
         write(*,*)'usage :'
         write(*,*) trim(ctmp),' frem rmax irand_seed  infile  outfile'
         write(*,*)
      ...
      call get_com_arg(3, irand_seed0, "seed for RNG")
...
!
      ...
      read(15,*) c6,boxl   ;print *,' boxl = ',boxl
!
      natom_max = natom
      boxl = boxl/Angstrom
      boxl2 = boxl*0.5_wp
