...
PROGRAM SIMBOX
      ...
      integer:: icx_n,icy_n,icz_n,icl,icly,iclz,irand_seed0,nohnew
...
!         print *,bondl(ibmax(1))
         ...
         ibmax = maxloc(bondl(1:nbondtot))
!         print *,bondl(ibmax(1))
!         print *,'   ',rxyz(ibond(1,ibmax(1)),1:3)
!         print *,'   ',rxyz(ibond(2,ibmax(1)),1:3)
!         r1 = rxyz(ibond(1,ibmax(1)),1:3)-rxyz(ibond(2,ibmax(1)),1:3)
!         print *,'r1 ',r1
         call pbc(r1)
!         print *,'r1 ',r1
!r1(1:3) = r1(1:3) - boxl*anint(r1(1:3)*boxli)
!if (abs(r1(1)) > boxl2) r1(1) = r1(1) - sign(boxl,r1(1))
!if (abs(r1(2)) > boxl2) r1(2) = r1(2) - sign(boxl,r1(2))
!if (abs(r1(3)) > boxl2) r1(3) = r1(3) - sign(boxl,r1(3))
!         print *,'r1 ',r1
!         print *,'|r1| ',sqrt(dot_product(r1,r1))
