...
!   USE crossbond_mod
   ...
   integer,allocatable:: special_xy(:),special_xz(:)
   integer,allocatable:: special_yz(:),special_xyz(:)
   integer:: n_special_xy,n_special_xz
   integer:: n_special_yz,n_special_xyz
   integer:: natomc
...
print*, 'special_xy = ',special_xy(1:10)
print*, 'special_xz = ',special_xz(1:10)
print*, 'special_yz = ',special_yz(1:10)
print*, 'special_xyz = ',special_xyz(1:10)
!stop
...
print*, 'atomnum1 xy',  atomnum1
print*, 'atomnum2 xy',  atomnum2                  
                  if (atomnum1 == 0 .OR. atomnum2 == 0) CYCLE
                  if (rxyz(atomnum1,1)<0.0 .AND. rxyz(atomnum1,2)<0.0) then
                     nc = ixyz2n(2*nl+n2ixyz(ib,1),2*nl+n2ixyz(ib,2),n2ixyz(ib,3))
                  else if (rxyz(atomnum1,1)<0.0 .AND. rxyz(atomnum1,2)>0.0) then
                     nc = ixyz2n(n2ixyz(ib,1)+1,2*nl+n2ixyz(ib,2),n2ixyz(ib,3))
                  else if (rxyz(atomnum2,1)<0.0 .AND. rxyz(atomnum2,2)<0.0) then
                     nc = ixyz2n(2*nl+n2ixyz(ib,1),2*nl+n2ixyz(ib,2),n2ixyz(ib,3))
                  else if (rxyz(atomnum2,1)<0.0 .AND. rxyz(atomnum2,2)>0.0) then
                     nc = ixyz2n(n2ixyz(ib,1)+1,2*nl+n2ixyz(ib,2),n2ixyz(ib,3))                  
                  end if
...
print*, 'atomnum1 xz',  atomnum1
print*, 'atomnum2 xz',  atomnum2                  
                  if (atomnum1 == 0 .OR. atomnum2 == 0) CYCLE
                  if (rxyz(atomnum1,1)<0.0 .AND. rxyz(atomnum1,2)<0.0) then
...
print*, 'atomnum2 xz',  atomnum2                      
                  if (atomnum1 == 0 .OR. atomnum2 == 0) CYCLE
                  if (rxyz(atomnum1,1)<0.0 .AND. rxyz(atomnum1,3)<0.0) then
                     nc = ixyz2n(n2ixyz(ib,1)+1,n2ixyz(ib,2),n2ixyz(ib,3)-1)
                  else if (rxyz(atomnum1,1)<0.0 .AND. rxyz(atomnum1,3)>0.0) then
                     nc = ixyz2n(2*nl+n2ixyz(ib,1),n2ixyz(ib,2),n2ixyz(ib,3)+1)
                  else if (rxyz(atomnum2,1)<0.0 .AND. rxyz(atomnum1,3)<0.0) then
                     nc = ixyz2n(n2ixyz(ib,1)+1,n2ixyz(ib,2),n2ixyz(ib,3)-1)
                  else if (rxyz(atomnum2,1)<0.0 .AND. rxyz(atomnum2,3)>0.0) then
                     nc = ixyz2n(2*nl+n2ixyz(ib,1),n2ixyz(ib,2),n2ixyz(ib,3)+1)                     
                  end if
                  CALL set_proximity(atomnum1,atomnum2,atomnum2+(nc-ib)*natom) 
                  CALL set_proximity(atomnum2+(nc-ib)*natom,atomnum1+(nc-ib)*natom,atomnum1)                     
...
print*, 'atomnum2 xz',  atomnum2                    
         ...
         if (negy) then
            if (negz) then
                do kk = 1, lst_neg_yz%n
                  atomnum1 = lst_neg_yz%ind((ib-1)*nbondtot+kk)
                  atomnum2 = lst_pos_yz%ind((ib-1)*nbondtot+kk)
print*, 'atomnum1 xz',  atomnum1
print*, 'atomnum2 xz',  atomnum2                     
                  if (atomnum1 == 0 .OR. atomnum2 == 0) CYCLE
                  if (rxyz(atomnum1,1)<0.0 .AND. rxyz(atomnum1,3)<0.0) then
...
!print*, 'proximity(',atomnum1,',:)', proximity(atomnum1,:)
!print*, 'proximity(',atomnum2,',:)', proximity(atomnum2,:)
!print*, 'proximity(',atomnum1+(nc-ib)*natom,',:)', proximity(atomnum1+(nc-ib)*natom,:)
!print*, 'proximity(',atomnum2+(nc-ib)*natom,',:)', proximity(atomnum2+(nc-ib)*natom,:)
