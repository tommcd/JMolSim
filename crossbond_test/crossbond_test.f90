...
! ACT I - box creation
      ...
      integer:: j,i,n,ib,k,imve,natomc,ix,iy,iz,iu3,ic,jj,nc
...
!
      allocate(lst_negative_x%i(n_crossbondtot),lst_negative_y%i(n_crossbondtot))
      allocate(lst_negative_z%i(n_crossbondtot))
      allocate(lst_positive_x%i(n_crossbondtot),lst_positive_y%i(n_crossbondtot))
      allocate(lst_positive_z%i(n_crossbondtot))
...
!
      ...
      CALL crossbond_correct(nl,crossbond_x,crossbond_y,crossbond_z)
