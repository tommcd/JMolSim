              ...
              ! if(atomnum1==0 .AND. atomnum2==0) EXIT
               ...
               do i = 1,lst_negative_y%n
                  if (atomnum1==lst_negative_y%ind((ib-1)*nbondtot+i)  &
                     ...
                     !lst_negative_y%ind((ib-1)*nbondtot+i) = atomnum1
                     lst_positive_y%ind((ib-1)*nbondtot+i) = atomnum2+(nc-ib)*natom
                  elseif (atomnum2==lst_negative_y%ind((ib-1)*nbondtot+i) &
                     .AND.atomnum1==lst_positive_y%ind((ib-1)*nbondtot+i)) then
                     lst_negative_y%ind((ib-1)*nbondtot+i) = atomnum2+(nc-ib)*natom
                     !lst_positive_y%ind((ib-1)*nbondtot+i) = atomnum1
                  end if
               end do 
               do i = 1,lst_negative_z%n
                  if (atomnum1==lst_negative_z%ind((ib-1)*nbondtot+i) &
                     ...
                     !lst_negative_z%ind((ib-1)*nbondtot+i) = atomnum1
                     lst_positive_z%ind((ib-1)*nbondtot+i) = atomnum2+(nc-ib)*natom
                  elseif (atomnum2==lst_negative_z%ind((ib-1)*nbondtot+i) &
                     .AND.atomnum1==lst_positive_z%ind((ib-1)*nbondtot+i)) then     
                     !lst_negative_z%ind((ib-1)*nbondtot+i) = atomnum2+(nc-ib)*natom
                     lst_positive_z%ind((ib-1)*nbondtot+i) = atomnum1
                  end if
               end do               
            end do
...
!         print*, 'ifirst 1     = ',ifirst
!         print*, 'proximity(',ifirst,':)',proximity(ifirst,:)
!         print*, 'proximity(',k,':)',proximity(k,:)         
!         stop ': 1 proximity not consistent. fan...fucking...tastic!!!'
!      end if
!      call check_proximity2(consistent,ifirst)
!      if (.NOT. consistent) then      
!         print*, 'consistent 2 = ',consistent
!         print*, 'ifirst 2     = ',ifirst   
!         stop ': 2 proximity not consistent. fan...fucking...tastic!!!'
!      end if
...
!      call check_proximity(consistent,ifirst,k)
!      if (.NOT. consistent) then
!         print*, 'consistent 3 = ',consistent
!         print*, 'ifirst 3     = ',ifirst
!         print*, 'proximity(',ifirst,':)',proximity(ifirst,:)
!         stop ': 3 proximity not consistent. fan...fucking...tastic!!!'
!      end if
!      call check_proximity2(consistent,ifirst)
!      if (.NOT. consistent) then      
!         print*, 'consistent 4 = ',consistent
!         print*, 'ifirst 4     = ',ifirst   
!         stop ': 4 proximity not consistent. fan...fucking...tastic!!!'
!      end if
