...
print*,'denprofgrid'
      Accessible = .true.
      call Henrys_law_grid(probe_CO2,Accessible(:,:,1:Nz_top,iN2),grid,Nz_top, &
                           n_try_henry,fover_henry,rcutH,henryk(:,:,1:Nz_top,iN2))
      print*,'henryk(:,:,1:Nz_top,iN2=',henryk(:,:,1:Nz_top,iN2)
...
print*,'Accessible(:,:,1:Nz_top,iN2)=',Accessible(:,:,1:Nz_top,iN2)
