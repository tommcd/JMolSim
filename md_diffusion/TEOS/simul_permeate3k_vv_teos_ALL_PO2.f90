...
CONTAINS
   ...
   SUBROUTINE insert_mol_GAS(n_add,n_atom,mol_vec,real_xyz,ntrial,rad1,rlower,rupper,n_mol,fover,self_overlap_check)
      integer,intent(in):: ntrial,n_add
...
!      print*,'mol_vec(1,2) =  ACO2',mol_vec(1,2) 
!      print*,'mol_vec(1,3) =  ACO2',mol_vec(1,3)
!!
...
print*,'denprofgrid'
      Accessible = .true.
      call Henrys_law_grid(probe_CO2,Accessible(:,:,1:Nz_top,iO2),grid,Nz_top, &
                           n_try_henry,fover_henry,rcutH,henryk(:,:,1:Nz_top,iO2))
      print*,'henryk(:,:,1:Nz_top,iO2=',henryk(:,:,1:Nz_top,iO2)
...
print*,'Accessible(:,:,1:Nz_top,iO2)=',Accessible(:,:,1:Nz_top,iO2)
...
!      mol_vec(1,3) = 0.0_wp
      mol_vec(2,:) = 0.0_wp
      mol_vec(3,:) = 0.0_wp
      call insert_mol_accessible(n_O2,n_atom_o2,mol_vec(:,1:n_atom_o2),Ox_xyz,100,rad_Ox,8,Accessible(:,:,1:Nz_top,1),grid,fover,check_self_overlap)
...
!      mol_vec(1,3) = 0.0_wp
      mol_vec(2,:) = 0.0_wp
      mol_vec(3,:) = 0.0_wp
      call insert_mol_accessible(n_N2,n_atom_n2,mol_vec(:,1:n_atom_n2),N2_xyz,100,rad_N2,8,Accessible(:,:,1:Nz_top,1),grid,fover,check_self_overlap)
...
!      print*,'mol_vec(1,2) =  ACO2',mol_vec(1,2) 
!      print*,'mol_vec(1,3) =  ACO2',mol_vec(1,3)
      call insert_mol_accessible(n_CO2,n_atom_co2,mol_vec(:,1:n_atom_co2),CO2_xyz,100,rad_CO2,8,Accessible(:,:,1:Nz_top,1),grid,fover,check_self_overlap)
