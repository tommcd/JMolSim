...
PROGRAM SIMBOX
      ...
      real(wp),parameter:: dtreal = 2.0_wp
      integer,parameter:: n_short = 8
      integer,parameter:: nequib = 1000
      integer,parameter:: nsamp = 1!25
      integer,parameter:: nprint_all = 1!2500
      ...
      real(wp)::CL,time,Ek,rad_Ox(3),rad_N2(3),rad_CO2(3),rr(3),ULJEL(40),dt_short,UEL
      real(wp):: e_bond_O2,e_bond_CO2(40),e_bond_N2,e_angle_CO2(40)
...
write(97,55) time + i_short*(dtreal/n_short),(co2_xyz(ii,1,j),co2_xyz(ii,2,j),co2_xyz(ii,3,j),j = 1,3)
write(98,55) time + i_short*(dtreal/n_short),(r_CO2_uc(ii,1,j),r_CO2_uc(ii,2,j),r_CO2_uc(ii,3,j),j = 1,3)
write(99,55) time + i_short*(dtreal/n_short),(rcm_co2_uc(ii,j),j = 1,3)
...
print *,'istep = ',istep,'ishort = ',i_short
print *,'e_bond_o2 = ',e_bond_o2
print *,'e_bond_n2 = ',e_bond_n2
print *,'e_bond_co2 = ',sum(e_bond_co2)
print *,'e_angle_co2 = ',sum(e_angle_co2)
